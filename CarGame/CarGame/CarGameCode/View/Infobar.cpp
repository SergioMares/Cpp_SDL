...
void Infobar::drawInfo() {
    ...
    case Game::Playing:
    {
        ...
        string s =
            ...
            "   Dist: " + to_string(int(game->roadLength - game->car->getX())) +
            "   Vel: " + to_string(int(game->car->getVelocity())) +
            "   Power: " + to_string(game->power) +
            "   Time: " + to_string(game->time) +
            //"   BO: " + to_string(BadObject::instances) +
            //"   GO: " + to_string(GoodObject::instances) +
            "   Coins: " + to_string(game->coins);
        ;
